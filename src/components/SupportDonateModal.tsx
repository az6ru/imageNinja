...
import { sendYandexMetrikaEvent } from '@/lib/yandex-metrika'
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-slate-900 p-8 shadow-2xl border border-slate-800 flex flex-col items-center">
          ...
          >
            ...
            <input
              ...
              required
              placeholder="Сумма, ₽"
              className="w-full px-4 py-2 rounded-lg border border-slate-700 bg-slate-800 text-center text-lg font-bold focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder:text-slate-300"
            />
            <button
              type="submit"
